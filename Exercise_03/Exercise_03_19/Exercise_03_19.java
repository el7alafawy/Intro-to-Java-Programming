...
public class Exercise_03_19 {
	public static void main(String[] args) {
		...
		// Test if input is valid ( this check is WRONG, try (1,1) , (2,2) , (3,3) which can never form a triangle and it will tell you it's valid)
...
*/
		...
		// The correct check should be here
